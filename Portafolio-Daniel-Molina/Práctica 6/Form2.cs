...
namespace Práctica_6
{
    public partial class Form2 : Form
    {
        ...
        private void txtTelefono_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(txtTelefono, "Ingrese un número de teléfono válido...\nEl teléfono debe de tener guión");
            }
            else
            {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else if (txtTelefono.Text == "" || !Regex.IsMatch(txtTelefono.Text, patronTelefono))
            {
                MessageBox.Show("Ingrese un número de telefono válido\nEl número debe iniciar con(2-6-7)");
                txtTelefono.Focus();
            }
            else if (Registro.ContainsKey(txtTelefono.Text))
            {
                MessageBox.Show("Este número telefónico ya existe en el registo, no pueden existir dos números iguales...\nIngrese un número nuevo...");
            }
            else
            {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            if (txtTelefono.Text == "")
            {
                MessageBox.Show("Debe ingresar un número telefónico para realizar la busqueda");
            }
            else
            {
